...
pygame.display.set_caption("2 SPRITES")
all_sprites= pygame.sprite.Group()

sprite1= Sprite(pygame.Color('green'),50,50)
...
#This is the HW where my pygame screen wasnt working, so idk if code has any errors
